// Param021Dlg.cpp : implementation file
//
...
void CParam021Dlg::SetDirection(int direction)
{
    m_config.direction = direction;
    return;
}

void CParam021Dlg::SetRole(int role)
{
    m_config.role = (ROLE_E)role;
    return;
}

void CParam021Dlg::SetGroup(int grp)
{
    m_config.groupid = grp;
    return;
}

void CParam021Dlg::SetBlueMax(int bluemax)
{
    m_config.maxBlueFiled = bluemax;
    return;

}
void CParam021Dlg::SetBlueMin(int bluemin)
{
    m_config.minBlue = bluemin;
    return;
}
void CParam021Dlg::SetBlueThreshold(int bluethreshold)
{
    m_config.blueThreshold = bluethreshold;
    return;
}

void CParam021Dlg::SetServer(char* server)
{
    memcpy(m_config.alarmServer, server, strlen(server) + 1);
    return;
}
void CParam021Dlg::SetPort(int port)
{
    m_config.alarmPort = port;
    return;
}

void CParam021Dlg::SetHost(int host)
{
    m_config.alarmHostIndex = host;
    return;
}

void CParam021Dlg::SetLoopNum(unsigned int loopnum)
{
    m_config.loop_num = loopnum;
    return;
}

void CParam021Dlg::SetPalyWndIndex(unsigned int playWndIndexVal)
{
    m_config.playWndIndexVal = playWndIndexVal;
    return;
}

void CParam021Dlg::SetTransWait(int Wait2Sleep)
{
    m_config.Wait2Sleep = Wait2Sleep;
    return;
}

void CParam021Dlg::SetExitGameCopyFull(int exitGameCopyFull)
{
    m_config.exitGameCopyFull = exitGameCopyFull;
    return;
}

void CParam021Dlg::SetCleanPackageWhenStart(int cleanPackageWhenStart)
{
...
BOOL CParam021Dlg::OnInitDialog()
{
    ...
    m_config.taskType = TASK_TYPE_021;
...
CParam021Dlg::CParam021Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CParam021Dlg::IDD, pParent), CParameters()
{
	//{{AFX_DATA_INIT(CParam021Dlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CParam021Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CParam021Dlg)
...
BEGIN_MESSAGE_MAP(CParam021Dlg, CDialog)
	//{{AFX_MSG_MAP(CParam021Dlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CParam021Dlg message handlers

void CParam021Dlg::OnOK() 
{
