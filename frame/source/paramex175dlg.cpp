// ParamEx175Dlg.cpp : implementation file
//
...
BOOL CParamEx175Dlg::OnInitDialog()
{
    ...
    m_config.taskType = TASK_TYPE_EX175;
...
CParamEx175Dlg::CParamEx175Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CParamEx175Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CParamEx175Dlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CParamEx175Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CParamEx175Dlg)
...
BEGIN_MESSAGE_MAP(CParamEx175Dlg, CDialog)
	//{{AFX_MSG_MAP(CParamEx175Dlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CParamEx175Dlg message handlers

void CParamEx175Dlg::OnOK() 
{
