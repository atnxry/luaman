// ParamFightDlg.cpp : implementation file
//
...
CParamFightDlg::CParamFightDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CParamFightDlg::IDD, pParent), CParameters()
{
	//{{AFX_DATA_INIT(CParamFightDlg)
	//}}AFX_DATA_INIT
}

BOOL CParamFightDlg::OnInitDialog()
{
    ...
    m_config.taskType = TASK_TYPE_FIGHT;
...
void CParamFightDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CParamFightDlg)
...
BEGIN_MESSAGE_MAP(CParamFightDlg, CDialog)
	//{{AFX_MSG_MAP(CParamFightDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CParamFightDlg message handlers

void CParamFightDlg::OnOK() 
{
