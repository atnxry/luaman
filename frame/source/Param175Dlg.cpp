// Param175Dlg.cpp : implementation file
//
...
BOOL CParam175Dlg::OnInitDialog()
{
    ...
    m_config.taskType = TASK_TYPE_175;
...
CParam175Dlg::CParam175Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CParam175Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CParam175Dlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CParam175Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CParam175Dlg)
...
BEGIN_MESSAGE_MAP(CParam175Dlg, CDialog)
	//{{AFX_MSG_MAP(CParam175Dlg)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CParam175Dlg message handlers
void CParam175Dlg::OnOK() 
{
