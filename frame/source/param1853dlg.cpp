// Param1853Dlg.cpp : implementation file
//
...
void CParam1853Dlg::SetDirection(int direction)
{
    m_config.direction = direction;
    return;
}

void CParam1853Dlg::SetRole(int role)
{
    m_config.role = (ROLE_E)role;
    return;
}

void CParam1853Dlg::SetGroup(int grp)
{
    m_config.groupid = grp;
    return;
}

void CParam1853Dlg::SetBlueMax(int bluemax)
{
    m_config.maxBlueFiled = bluemax;
    return;

}
void CParam1853Dlg::SetBlueMin(int bluemin)
{
    m_config.minBlue = bluemin;
    return;
}
void CParam1853Dlg::SetBlueThreshold(int bluethreshold)
{
    m_config.blueThreshold = bluethreshold;
    return;
}

void CParam1853Dlg::SetServer(char* server)
{
    memcpy(m_config.alarmServer, server, strlen(server) + 1);
    return;
}
void CParam1853Dlg::SetPort(int port)
{
    m_config.alarmPort = port;
    return;
}

void CParam1853Dlg::SetHost(int host)
{
    m_config.alarmHostIndex = host;
    return;
}

void CParam1853Dlg::SetLoopNum(unsigned int loopnum)
{
    m_config.loop_num = loopnum;
    return;
}

void CParam1853Dlg::SetPalyWndIndex(unsigned int playWndIndexVal)
{
    m_config.playWndIndexVal = playWndIndexVal;
    return;
}

void CParam1853Dlg::SetTransWait(int Wait2Sleep)
{
    m_config.Wait2Sleep = Wait2Sleep;
    return;
}

void CParam1853Dlg::SetExitGameCopyFull(int exitGameCopyFull)
{
    m_config.exitGameCopyFull = exitGameCopyFull;
    return;
}

void CParam1853Dlg::SetCallBabyDie(int callbabydie)
{
    m_config.callbabydie = callbabydie;
    return;
}

void CParam1853Dlg::SetCleanPackageTime(int cleanPackageTime)
{
    m_config.cleanPackageTime = cleanPackageTime;
}

void CParam1853Dlg::SetCleanPackageWhenStart(int cleanPackageWhenStart)
{
    m_config.cleanPackageWhenStart = cleanPackageWhenStart;
    return;
}

void CParam1853Dlg::SetCleanPackage1(int cleanPackage1)
{
    if (cleanPackage1)
    {
...
void CParam1853Dlg::SetCleanPackage2(int cleanPackage2)
{
    if (cleanPackage2)
    {
...
void CParam1853Dlg::SetCleanPackage3(int cleanPackage3)
{
    if (cleanPackage3)
    {
...
void CParam1853Dlg::SetCleanPackage4(int cleanPackage4)
{
    if (cleanPackage4)
    {
...
void CParam1853Dlg::SetCleanPackage5(int cleanPackage5)
{
    if (cleanPackage5)
    {
...
void CParam1853Dlg::SetCleanPackage(int cleanPackage)
{
    m_config.cleanPackageX = cleanPackage;
}

void CParam1853Dlg::SetWaitCopytime(int waitCopytime)
{
    m_config.waitCopytime = waitCopytime;
}

void CParam1853Dlg::SetBluebloodChecktime(int bluebloodChecktime)
{
    m_config.bluebloodChecktime = bluebloodChecktime;
}

void CParam1853Dlg::SetBlockTimes(int blockTimes)
{
    m_config.blockTimes = blockTimes;
}
#endif

BOOL CParam1853Dlg::OnInitDialog()
{
    ...
    m_config.taskType = TASK_TYPE_1853;
...
CParam1853Dlg::CParam1853Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CParam1853Dlg::IDD, pParent), CParameters()
{
	//{{AFX_DATA_INIT(CParam1853Dlg)
	//}}AFX_DATA_INIT
}


void CParam1853Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CParam1853Dlg)
...
BEGIN_MESSAGE_MAP(CParam1853Dlg, CDialog)
	//{{AFX_MSG_MAP(CParam1853Dlg)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CParam1853Dlg message handlers
void CParam1853Dlg::OnOK() 
{
