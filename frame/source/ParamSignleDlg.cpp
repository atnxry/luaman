// ParamSignleDlg.cpp : implementation file
//
...
BOOL CParamSignleDlg::OnInitDialog()
{
    ...
    m_config.taskType = TASK_TYPE_SIGNLE;
...
CParamSignleDlg::CParamSignleDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CParamSignleDlg::IDD, pParent), CParameters()
{
	//{{AFX_DATA_INIT(CParamSignleDlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CParamSignleDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CParamSignleDlg)
...
BEGIN_MESSAGE_MAP(CParamSignleDlg, CDialog)
	//{{AFX_MSG_MAP(CParamSignleDlg)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CParamSignleDlg message handlers
void CParamSignleDlg::OnOK() 
{
