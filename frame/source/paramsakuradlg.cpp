// ParamSakuraDlg.cpp : implementation file
//
...
BOOL CParamSakuraDlg::OnInitDialog()
{
    ...
    m_config.taskType = TASK_TYPE_SAKURA;
...
CParamSakuraDlg::CParamSakuraDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CParamSakuraDlg::IDD, pParent), CParameters()
{
	//{{AFX_DATA_INIT(CParamSakuraDlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CParamSakuraDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CParamSakuraDlg)
...
BEGIN_MESSAGE_MAP(CParamSakuraDlg, CDialog)
	//{{AFX_MSG_MAP(CParamSakuraDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CParamSakuraDlg message handlers

void CParamSakuraDlg::OnOK() 
{
