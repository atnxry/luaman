...
CString Idmsoft::EnumWindowSuper(LPCTSTR spec1, long flag1, long type1, LPCTSTR spec2, long flag2, long type2, long sort)
{
	CString result;
	static BYTE parms[] =
...
long Idmsoft::DownloadFile(LPCTSTR url, LPCTSTR save_file, long timeout)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_I4;
...
long Idmsoft::EnableKeypadMsg(long en)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long Idmsoft::EnableMouseMsg(long en)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long Idmsoft::RegNoMac(LPCTSTR code, LPCTSTR Ver)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR;
...
long Idmsoft::RegExNoMac(LPCTSTR code, LPCTSTR Ver, LPCTSTR ip)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BSTR;
...
long Idmsoft::SetEnumWindowDelay(long delay)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long Idmsoft::FindMulColor(long x1, long y1, long x2, long y2, LPCTSTR color, double sim)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_BSTR VTS_R8;
...
CString Idmsoft::GetDict(long index, long font_index)
{
	CString result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
