// ParamDotaskDlg.cpp : implementation file
//
...
BOOL CParamDotaskDlg::OnInitDialog()
{
    ...
    m_config.taskType = TASK_TYPE_DOTASK;
...
CParamDotaskDlg::CParamDotaskDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CParamDotaskDlg::IDD, pParent), CParameters()
{
	//{{AFX_DATA_INIT(CParamDotaskDlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CParamDotaskDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CParamDotaskDlg)
...
BEGIN_MESSAGE_MAP(CParamDotaskDlg, CDialog)
	//{{AFX_MSG_MAP(CParamDotaskDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CParamDotaskDlg message handlers

void CParamDotaskDlg::OnOK() 
{
